...
In this class, you will be accessing projects through GitHub. If you need feedback or help with your code, we'll also use GitHub to send it back and forth. We won't be using GitHub to its fullest extent, but this will at least give you some basic familiarity with the software. We are using GitHub—and not Bitbucket or GitLab—because GitHub is widely used in the R community. However, it's worth pointing out that the GitHub company has [a history of controversy](https://en.wikipedia.org/wiki/GitHub#Controversies) and that it has recently come under [increased criticism](https://sfconservancy.org/blog/2022/jun/30/give-up-github-launch/) from the same open source community that GitHub claims to serve. For the time being, this course continues to use GitHub. As we'll discuss throughout the semester, it's important to be attentive to ethics and values in data science, including when selecting tools and services.
...
This section provides specific instructions. What you see while following these steps may not always be exactly the same because of operating system and other differences. If something doesn't match perfectly what you see, use common sense to figure out the next best option.

Once you've created a GitHub account, please navigate to [this GitHub repository](https://github.com/hengzheng-uky/LIS-ICT-661), which contains some crucial files for our class. If you have your browser window open wide enough, you should see a green *Use this template* button to the right of the menu above the list of files and directories (or folders). Click that button and, if prompted, click on *Create a new repository*. 
...
If/as you continue to work with RStudio and GitHub, you'll get a feel for what kind of directory names are most helpful to you. Use a consistent format so that repositories for this class can be identified and organized easily. Give this project a name that follows this format:

`yourlastname_yourfirstname_661`

That is, my project would be named `Zheng_Heng_661`.
...
Once you're in settings, navigate to *Collaborators* and then *Add people*. Then, enter my GitHub username, `hengzheng-uky`. Having access to your repository will make helping you with your code much easier in the future!
...
There are plenty of other ways to use Git and GitHub, including the command line and RStudio itself, and if you're serious about data science, I recommend learning more about both of those options (the [Happy Git and GitHub for the useR](https://happygitwithr.com/index.html) website is helpful and thorough). You're even free to try them this semester, but remember that the instructions for this course assume you're using this client. GitHub Desktop provides a straightforward interface for the basic GitHub tasks used in this course.
...
**This next part is really important.** Over the past few years, professors in technical fields have [increasingly noticed](https://www.theverge.com/22684730/students-file-folder-directory-structure-education-gen-z) that their students aren't as familiar with computers' file and folder systems as they are. Knowing which files are in which folders is **critical** for finding and managing them. In recent decades, the rise of cloud storage services (especially search-heavy ones like Google Drive), mobile operating systems, and other developments have made it so that your everyday computer user doesn't have to (and, in the case of mobile devices, maybe can't? at least not easily?) navigate through the different folders on their computer to save or retrieve files.

However, if you're working with programming tasks (like we are this semester), **you do need to know where files are saved on your computer, what folders other folders are stored in, and that sort of thing**. Not paying close attention to this is going to create at least mild inconveniences and, if you're unlucky, more serious errors that will get in the way of your work.

Troubleshooting and office hours in this class may involve these file and folder issues. Support is available, but **you can save yourself a lot of hassle over the next several weeks if you pay close attention to these details**. If you genuinely don't know what I'm talking about, ask for help now and save yourself some trouble in the future!
