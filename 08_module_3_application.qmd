...
Begin this walkthrough by starting RStudio. By way of reminder, as you open up the program, you should see something similar to Figure @fig-RStudio-interface-2.

```{r fig-RStudio-interface-2, echo=FALSE, fig.cap="RStudio interface to R.", out.width="93%", purl=FALSE}
