...
```{r echo=FALSE}
knitr::include_graphics("images/scatterplot_regression.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("images/y_y_hat.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("images/scatterplot_regression_line.png")
```
