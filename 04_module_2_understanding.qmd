...
To introduce *data science*, it makes sense that we ought to talk about *data* first. The word *data* is the plural of the the Latin word *datum*. One quick word before we continue: Because the word *data* is the plural of *datum*, this section uses the plural form in its title: "What Are Data?" However, it's quite common in American English to treat data as a singular word, so "What Is Data?" is also a common formulation. Either usage is acceptable; use whichever comes more naturally to you.
